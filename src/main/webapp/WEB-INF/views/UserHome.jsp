...
<body>
	<nav class="navbar navbar-expand-md navbar-dark bg-dark">
		...
		<img src="expense_logo.jpeg" alt="Admin" width="270" height="100">&nbsp;&nbsp;&nbsp;
	                ...
	                <li class="nav-item">
	                    ...
	                    <div class="collapse" id="manageCategories" aria-expanded="false">
	                        <ul class="flex-column pl-2 nav">
	                            ...
	                            <li class="nav-item">
	                                <a class="nav-link text-truncate py-1" href="manageSubCategories"><span>Manage Sub-Categories</span></a>
	                            </li>
	                        </ul>
	                    </div>
	                </li>
	                ...
	                <li class="nav-item">
	                    ...
	                    <div class="collapse" id="managePayees" aria-expanded="false">
	                        <ul class="flex-column pl-2 nav">
	                            ...
	                            <li class="nav-item">
	                                <a class="nav-link text-truncate py-1" href="managePayees"><span>Modify Payees</span></a>
	                            </li>
	                        </ul>
	                    </div>
	                </li>
	                ...
	                <li class="nav-item">
	                    ...
	                    <div class="collapse" id="manageExpenses" aria-expanded="false">
	                        <ul class="flex-column pl-2 nav">
	                            ...
	                            <li class="nav-item">
	                                <a class="nav-link text-truncate py-1" href="PDFGeneration"><span>Expense Report</span></a>
	                            </li>
	                        </ul>
	                    </div>
	                </li>

...
<div class="container">
	<div class="row">
		<div class="col-md-6">
			<s:form action="ExpenceTracking" name="expenseForm" style="border:1px solid #ccc" modelAttribute="validate8" method="post">
			  <div class="container">
				...
				<div class="form-group">
			    	...
			    	<s:input class="form-control" style="width:40%;" type="number" placeholder="Enter your amount" path="amount" />
				...
				<div class="form-group">
					...
					<select style="width:40%;" name="categoryName" id="categoryName" class="form-control" required>
						<option value="Select Your Category">Select Category</option>
				...
				<div class="form-group">
					...
					<p><b>(Choose your respective sub-category name...)</b></p>
					<select style="width:40%;" id="subCatName" name="subCatName" class="form-control" required>
						<option value="Select Your Sub Category">Select Sub Category</option>
			    ...
			    <div class="form-group">
					...
					<select style="width:40%;" id="accName" name="accName" class="form-control" required>
			    ...
			    <div class="form-group">
					...
					<input type="text" style="width:40%;" name="paymentMethod" class="form-control" id="paymentMethod" />
...
<script type="text/javascript">
	function checkSubCategory(){
		let categoryName = document.expenseForm.categoryName.value;
	...
	function getAccType(){
		let accName = document.expenseForm.accName.value;
		console.log(accName);
		$.get("checkAccName/"+accName,function(data){
			console.log(data);
			$("#paymentMethod").val(data.accTypeName);
		});
	}
